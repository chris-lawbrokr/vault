...
- Pause client emails
- How do we supplement the monthly emails?
- Whitelist reports for certain customers only
- Opt in email campaigns

- Add edit email option.
- New dashboard should merge stripe, hubspot, mailchimp etc so that our system is the one source of truth.
